...
contract CryptoWeridos is ERC721Full, ERC721MetadataMintable, AccessControl, Pausable {
...
contract CryptoFacesMarketPlace{
     ...
     * Constructor *
     ***************/
    constructor(CryptoWeridos _CFContract) public {
...
contract Escrow {
     ...
     * Constructor *
     ***************/
    constructor(CryptoWeridos _CFContract, address _seller, address _buyer, uint256 _tokenId, uint256 _tokenValue) public {
        seller = _seller;
        buyer = _buyer;
        tokenId = _tokenId;
